...
class WLANThermoConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_user(self, user_input: dict[str, Any] | None = None) -> FlowResult:
        ...
        if user_input is not None:
            ...
            model_version = user_input.pop("WlanThermo Model", "Mini-V3")
            user_input["model_version"] = model_version
        ...
        schema = vol.Schema({
            ...
            vol.Required("WlanThermo Model", default="Mini-V3"): vol.In(MODEL_OPTIONS),
        })
